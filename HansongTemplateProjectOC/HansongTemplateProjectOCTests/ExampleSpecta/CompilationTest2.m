...
SpecEnd
@interface CompilationTest2 : XCTestCase
...
- (void)testMultipleExamples {
  ...
  assertEqual(example2Ran, 0);
  assertEqual(example3Ran, 0);
  assertEqual(example4Ran, 0);
  assertEqual(example5Ran, 0);
  assertEqual(example6Ran, 0);
}
@end
