//
//  OKNSURLConnectionDelegateTests.m
...
@interface OKNSURLConnectionDelegateTests : XCTestCase<NSURLConnectionDataDelegate>

@end
static const NSTimeInterval kResponseTimeMaxDelay = 2.5;

@implementation OKNSURLConnectionDelegateTests
{
    NSMutableData* _data;
    NSError* _error;
